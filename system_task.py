...
def play_music():
    ...
    music_dir = "C:\\Users\\Kishan\\Music"
...
def play_focus():
    speak_module.speak("Here you go with video")
    power=r"C:\Users\Kishan\Videos\Ariana Grande - Focus.mp4"
    os.startfile(power)
    return("playing focus")

def photo():
    speak_module.speak("Here you go with photo")
    photo_dir = "C:\\Users\\Kishan\\Pictures"
...
def vs_code():
    ...
    os.startfile(r"C:\Users\Kishan\AppData\Local\Programs\Microsoft VS Code\Code.exe")
...
def shell():
    ...
    os.startfile(r"C:\Python38\Lib\idlelib\idle.pyw")
